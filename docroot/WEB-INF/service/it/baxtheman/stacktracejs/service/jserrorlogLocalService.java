...
/**
 * Provides the local service interface for jserrorlog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author @baxtheman
 * @see jserrorlogLocalServiceUtil
...
public interface jserrorlogLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link jserrorlogLocalServiceUtil} to access the jserrorlog local service. Add custom service methods to {@link it.baxtheman.stacktracejs.service.impl.jserrorlogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
